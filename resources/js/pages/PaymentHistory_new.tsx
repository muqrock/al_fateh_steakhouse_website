      ...
      <div className="max-w-4xl mx-auto px-6 py-10 relative z-10">
        <div className="bg-amber-300/90 rounded-xl shadow-2xl p-8">
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-6">
            <div className="bg-white rounded-lg border border-orange-400 p-4 shadow-sm">
              <h3 className="text-sm font-medium text-gray-500">Total Orders</h3>
              <p className="text-2xl font-bold text-gray-800">{orders.data.length}</p>
            </div>
            <div className="bg-white rounded-lg border border-orange-400 p-4 shadow-sm">
              <h3 className="text-sm font-medium text-gray-500">Total Spent</h3>
              <p className="text-2xl font-bold text-green-600">RM {totalSpent.toFixed(2)}</p>
            </div>
            <div className="bg-white rounded-lg border border-orange-400 p-4 shadow-sm">
