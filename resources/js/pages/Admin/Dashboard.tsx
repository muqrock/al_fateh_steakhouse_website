      ...
      <h1 style={{ fontSize: 32, fontWeight: 700, marginBottom: 32, color: '#4e2e1e' }}>Restaurant Dashboard</h1>
          ...
          <div style={{ 
            ...
            <div style={{ textAlign: 'center', marginBottom: 16 }}>
              <p style={{ 
                ...
                {stats.customer_growth_percentage >= 0 ? '+' : ''}{stats.customer_growth_percentage}%
              </p>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {stats.popular_menu_items.length > 0 ? stats.popular_menu_items.map((item, index) => (
                <div key={index} style={{ 
                  display: 'flex', 
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
              {stats.recent_reservations.length > 0 ? stats.recent_reservations.map((reservation, index) => (
                <div key={index} style={{ 
                  padding: 16, 
                  background: '#fafafa', 
                  borderRadius: 12,
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                    ...
                    <div style={{ textAlign: 'right', fontSize: 12, color: '#6b7280' }}>
                      <p style={{ margin: '0 0 2px 0' }}>{reservation.date} at {reservation.time}</p>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            {stats.recent_reviews.length > 0 ? stats.recent_reviews.map((review, index) => (
              <div key={index} style={{ 
                padding: 20, 
                background: '#fafafa', 
                borderRadius: 12,
                ...
                <p style={{ color: '#374151', fontSize: 14, lineHeight: 1.6, margin: 0, fontStyle: 'italic' }}>
                  "{review.comment}"
                </p>
              </div>
            )) : (
