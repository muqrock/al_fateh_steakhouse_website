                            ...
                            >
                                ...
                                {review.admin_reply && editingReply !== review.id && (
                                    ...
                                    >
                                        ...
                                        <p style={{ fontSize: 13, color: '#374151', margin: 0, lineHeight: 1.5 }}>{review.admin_reply}</p>
                                    </div>
                                )}


                                {/* Only show one reply/edit box at a time, prioritizing edit (yellowish) */}
                                {editingReply === review.id ? (
                                    ...
                                    >
                                        ...
                                        />
                                        {errors.admin_reply && (
                                            <p style={{ color: '#ef4444', fontSize: '12px', marginBottom: 8 }}>{errors.admin_reply}</p>
                                        )}
                                        <div style={{ display: 'flex', gap: 8 }}>
                                            <button
