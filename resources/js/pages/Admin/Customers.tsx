        ...
        <AdminLayout currentPage="Customer List">
            ...
            >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 16, marginBottom: 16 }}>
                    ...
                    {/* Date From */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Join Date From</label>
                        <input
                            type="date"
                            value={dateFrom}
                    ...
                    {/* Date To */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Join Date To</label>
                        <input
                            type="date"
                            value={dateTo}
                    ...
                    {/* Min Spend */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Min Spend (RM)</label>
                        <input
                            type="number"
                            value={minSpend}
                    ...
                    {/* Max Spend */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Max Spend (RM)</label>
                        <input
                            type="number"
                            value={maxSpend}
                    ...
                    {/* Sort By */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Sort By</label>
                        <select
                            value={sortBy}
                    ...
                    {/* Sort Order */}
                    <div>
                        <label style={{ display: 'block', fontSize: 14, fontWeight: 500, color: '#374151', marginBottom: 4 }}>Sort Order</label>
                        <select
                            value={sortOrder}
                            ...
                            {customers.data.length > 0 ? (
                                customers.data.map((customer: Customer) => (
                                    <tr key={customer.id} style={{ borderBottom: '1px solid #f8f9fa' }}>
                                        <td style={{ padding: '16px 12px', color: '#374151', fontWeight: 500 }}>{customer.name}</td>
                                        <td style={{ padding: '16px 12px', color: '#374151' }}>{customer.email}</td>
                                        <td style={{ padding: '16px 12px', color: '#6b7280', fontSize: 14 }}>{customer.joined_date}</td>
