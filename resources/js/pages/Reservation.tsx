...
const FormField: React.FC<FormFieldProps> = ({ id, label, children }) => (
    <div>
        <label htmlFor={id} className="mb-2 block text-sm font-bold text-orange-800">
            {label}
        </label>
            ...
            >
                <div className="flex min-h-screen flex-1 flex-col items-center justify-center">
                    <div className="rounded-xl bg-black/60 p-8 text-center">
                        <h2 className="mb-4 text-2xl font-bold text-white">Redirecting to Login...</h2>
            ...
            onSuccess: () => {
                Swal.fire({
                    ...
                    customClass: {
                        ...
                        confirmButton:
                            'bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 border-0 rounded-lg px-6 py-3 font-semibold shadow-lg transform hover:scale-105 transition-all duration-200',
                    },
                });
        ...
        >
            <div className="flex min-h-screen flex-1 flex-col">
                <div className="flex flex-1 items-center justify-center p-4">
                    <div className="w-full max-w-3xl rounded-xl border border-orange-200/40 bg-gradient-to-br from-orange-50/70 to-amber-50/70 p-8 shadow-2xl backdrop-blur-sm">
                        <h2 className="mb-6 text-center text-3xl font-bold text-orange-900 underline drop-shadow">Table Reservation</h2>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <FormField label="Full Name" id="name">
                                    ...
                                    <input
                                        ...
                                        value={data.name}
                                        disabled
                                        className="block w-full rounded-md border-orange-200 bg-orange-100/70 py-3 pl-10 text-orange-700"
                                    />
                                </FormField>
                            ...
                            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                                <FormField label="Phone Number" id="phone">
                                    <InputIcon>
                                        <svg className="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path
                                                fillRule="evenodd"
                                                d="M2 3.5A1.5 1.5 0 013.5 2h1.148a1.5 1.5 0 011.465 1.175l.716 3.223a1.5 1.5 0 01-1.052 1.767l-.933.267c-.41.117-.643.555-.48.95a11.542 11.542 0 006.254 6.254c.395.163.833-.07.95-.48l.267-.933a1.5 1.5 0 011.767-1.052l3.223.716A1.5 1.5 0 0118 15.352V16.5a1.5 1.5 0 01-1.5 1.5h-1.5A11.5 11.5 0 013.5 6.5h-1A1.5 1.5 0 012 5V3.5z"
                                                clipRule="evenodd"
                                            />
                                        </svg>
                                    </InputIcon>
                                    <input
                                        ...
                                        required
                                        className="block w-full rounded-md border-orange-200 bg-white/90 py-3 pl-10 text-orange-800 focus:border-orange-400 focus:ring-orange-400"
                                    />
                                ...
                                <FormField label="Number of Guests" id="guests">
                                    <InputIcon>
                                        <svg className="h-5 w-5 text-gray-400" fill="currentColor" viewBox="0 0 20 20">
                                            <path d="M7 8a3 3 0 100-6 3 3 0 000 6zM14.5 9a3.5 3.5 0 100-7 3.5 3.5 0 000 7zM1.496 18.28a.75.75 0 01-.256-1.453C2.116 16.24 3.349 15.5 5.5 15.5h9c2.152 0 3.384.74 4.26 1.327a.75.75 0 11-.992 1.126C16.992 17.39 16.006 17 14.5 17h-9c-1.506 0-2.492.39-3.26.908a.75.75 0 01-1.244-.328z" />
                                        </svg>
                                    </InputIcon>
                                    <select
                                        id="guests"
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="w-full rounded-lg bg-gradient-to-r from-orange-500 to-amber-500 px-6 py-4 font-bold text-white shadow-lg hover:from-orange-600 hover:to-amber-600"
                            >
                        ...
                        {userReservation && (
                            <div className="mt-10 rounded-lg border border-orange-300/70 bg-gradient-to-r from-orange-100 to-amber-100/90 p-6 shadow-md">
                                <h3 className="mb-4 text-center text-xl font-semibold text-orange-900">📋 Your Latest Reservation</h3>
                                    ...
                                    <table className="min-w-full divide-y divide-orange-300">
                                        ...
                                        <tbody className="bg-white/90 text-orange-800">
                                            <tr className="hover:bg-orange-50">
                                                <td className="px-4 py-3">{new Date(userReservation.reservation_date).toLocaleDateString()}</td>
                ...
                <footer className="mt-auto w-full bg-black/70 py-4 text-center text-sm text-white">
