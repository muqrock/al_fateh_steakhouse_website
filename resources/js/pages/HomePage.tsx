        ...
        <div className="flex items-center gap-4">
          {auth && auth.user && auth.user.name ? (
            <>
              ...
              <button onClick={handleLogout} title="Logout" className="text-white hover:text-orange-300 transition-colors duration-300">
            ...
            <button onClick={() => router.visit('/login')} title="Login" className="text-white hover:text-orange-300 transition-colors duration-300">
