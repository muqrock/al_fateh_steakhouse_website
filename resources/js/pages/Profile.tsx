      ...
      <div className="max-w-2xl mx-auto px-6 py-10 relative z-10">
        <div className="bg-amber-300/90 rounded-xl shadow-2xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-700 mt-2">Manage your account information</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full p-3 border border-orange-400 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400 bg-white text-gray-800"
                required
              />
              {errors.name && (
            ...
            <div className="flex gap-4">
              ...
              <button
                type="button"
                onClick={() => reset()}
                className="px-6 py-3 border border-orange-400 text-orange-600 font-bold rounded-lg hover:bg-orange-50 transition duration-300"
              >
                Reset
              </button>
            </div>
